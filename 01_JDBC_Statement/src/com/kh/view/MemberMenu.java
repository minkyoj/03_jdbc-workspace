...
public class MemberMenu {
	...
	/**
	 *  회원 추가 화면(서브화면)
	 *	즉, 추가하고자 하는 회원의 정보를 입력 받아서 회원 추가요청하는 창
	 */
	...
	/**
	 * 조회 서비스 요청시 조회결과가 있는 경우 사용자가 보게 될 응답화면
	 * @param message
	 */
	...
	/**
	 * 아이디 검색 서비스 요청시 조회결과가 없을 경우 사용자가 보게 될 응답화면
	 * @param string
	 */
	...
	/**
	 * 아이디 검색 서비스 요청시 조회결과가 있을 경우 사용자가 보게 될 응답화면
	 * @param string
	 */
